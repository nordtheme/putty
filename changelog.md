...
Implemented the main color theme file [`nord.reg`](https://github.com/nordtheme/putty/blob/develop/src/nord.reg). (@svengreb, #1, 3590df54)

Detailed information about features and install instructions can be found in the [README](https://github.com/nordtheme/putty/blob/develop/readme.md#installation).

<p align="center">
  <picture>
    <img src="https://raw.githubusercontent.com/nordtheme/putty/develop/src/assets/scrot-colortest.png" /><br />
  </picture>
